...
public static class Endpoints
{
    public static WebApplication MapEndpoints(this WebApplication app, IConfiguration configuration)
    {
        ...
        app.MapGet("/", () =>
        {
            ...
            return Results.Text($"<a href='https://id.twitch.tv/oauth2/authorize?response_type=code&client_id={clientId}&redirect_uri=http%3A%2F%2Flocalhost%3A5000%2Fcallback&scope=user%3Abot%20channel%3Abot%20chat%3Aedit%20chat%3Aread%20whispers%3Aread'>Login</a>", "text/html");
        });

        app.MapGet("/callback", async (HttpContext context, IChatService chatService) =>
        {
